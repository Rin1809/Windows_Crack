@echo off
title Windows 10 ALL version activator&cls&echo - Created by Rin&echo ************************************&echo Phien Ban Ho Tro:&echo - Windows 10 Home&echo - Windows 10 Professional&echo - Windows 10 Enterprise, Enterprise LTSB&echo - Windows 10 Education&echo.&echo.&echo ************************************ &echo Bat Dau Active Windows 10...
...
cscript //nologo c:\windows\system32\slmgr.vbs /ato | find /i "successfully" && (echo.& echo ************************************ & echo. & choice /n /c YN /m "Restart May Tinh Khong? [Y,N]?" & if errorlevel 2 exit) || (echo Kich Hoat That Bai, Tu Dong Thu Cach Khac... & echo Vui Long Cho... & echo. & echo. & set /a i+=1 & goto server)
echo ----------------------------
